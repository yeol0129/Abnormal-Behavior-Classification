...
paths0=[]
for dirname, _, filenames in os.walk('/Volumes/Siyeol_ssd/jupyter/지하철 역사 내 CCTV 이상행동 영상/Training/폭행/[원천]폭행_1/1'):
...
modelpath="./Resnet_model/{epoch:02d}-{val_loss:.4f}.hdf5"
